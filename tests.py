#This file contains tests that can be performed in order to test individual modules of the game Minesweeper.
...
tests = [(10,10,9), (12,12,24), (16,16,40)]    #The three difficults: Easy, Medium, and Hard.
...
for t in tests:
    ...
    gameboard_test.clearEmptyTiles(0, 1)
    gameboard_test.guaranteeEmptyTile(0, 1)
